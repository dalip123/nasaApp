...
<a class="navbar-brand" href="#"><img src="images/farms.png" height="100" width="100"></a>
</div>
</div>
	</nav>
	...
	<header id="fh5co-header" class="fh5co-cover" role="banner" style="background-image:url(images/images.jpg);">
			...
			<div class="row">
				<div class="col-lg-12 col-md-12">
					<div class="fh5co-blog animate-box">
						...
						<div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
							<button  style="width: 320px;" href="{{url('pathtrace')}} class="btn btn-primary">EVACUATION MAP</button>
						</div>
						</div> 
					</div>
				</div>
